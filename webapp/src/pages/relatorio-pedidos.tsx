...
const CenteredPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    scriptElement.onload = () => {
      ...
      const divElement = document.getElementById('viz1733362877425');
      if (divElement) {
    ...
    <>
      ...
      <div className="main-content">
        <div className="container">
          ...
          {/* Tableau Embed */}
          <div className='tableauPlaceholder' id='viz1733362877425' style={{ position: 'relative' }}>
            <noscript>
              <a href='#'>
                <img 
                  alt='História 1' 
                  src='https://public.tableau.com/static/images/Gr/GrficosPinheirinho/Histria1/1_rss.png' 
                  style={{ border: 'none' }} 
                />
              </a>
            </noscript>
            <object className='tableauViz'>
              ...
              <param name='name' value='GrficosPinheirinho/Histria1' />
              <param name='tabs' value='no' />
              <param name='toolbar' value='yes' />
              <param name='static_image' value='https://public.tableau.com/static/images/Gr/GrficosPinheirinho/Histria1/1.png' />
